...
@section('content')
    ...
    <div class="container mx-auto px-6 py-8">
      <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          <div class="px-6 py-4 border-b">
              <h1 class="text-2xl font-bold">Historique de vos réservations</h1>
          </div>
  ...
  <div class="max-w-6xl mx-auto p-6 text-center">
    <a href="commentaires.html" class="inline-block px-6 py-3 bg-[#95714F] text-white rounded-lg hover:bg-[#6d4927] transition-colors">
