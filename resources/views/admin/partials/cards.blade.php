...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
  ...
  <div class="bg-white rounded-xl shadow-md p-6">
    <div class="flex items-center justify-between mb-4">
      <h3 class="font-bold text-[#6d4927]">Chiffre d'affaires</h3>
    ...
    <p class="text-3xl font-bold mb-1">{{ number_format($chiffreAffaires, 2, ',', ' ') }} €</p>
  ...
  <div class="bg-white rounded-xl shadow-md p-6">
    ...
    <div class="mt-4">
      <a href="{{ route('admin.rooms') }}" class="text-sm text-[#95714F] flex items-center">
  ...
  <div class="bg-white rounded-xl shadow-md p-6">
    ...
    <div class="mt-4">
      <a href="{{ route('admin.staff') }}" class="text-sm text-[#95714F] flex items-center">
