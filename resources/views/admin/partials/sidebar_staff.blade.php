    ...
    <div class="flex flex-col h-full">
      <div class="p-6">
        ...
        <nav class="space-y-1">
          ...
          <a href="admin_staff.html" class="flex items-center space-x-3 px-3 py-3 rounded-lg bg-[#95714F] text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="admin_reservations.html" class="flex items-center space-x-3 px-3 py-3 rounded-lg transition-colors hover:bg-[#C7AF94] hover:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
