  ...
  <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-8 pt-8">
    ...
    <div class="flex-wrap justify-center items-center text-center">
      ...
      <ul class="space-y-2 text-sm">
        ...
        <li><a href="{{ route('chambres') }}" class="hover:text-[#95714F] transition-colors duration-300 inline-block transform hover:translate-x-1 no-underline">Nos chambres</a></li>
        <li><a href="{{ route('reservation') }}" class="hover:text-[#95714F] transition-colors duration-300 inline-block transform hover:translate-x-1 no-underline">Réserver</a></li>
      </ul>
    </div>
    ...
    <div class="flex-wrap justify-center items-center text-center">
      ...
      <ul class="space-y-2 text-sm">
        <li class="flex items-start">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#95714F] flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
          </svg>
          <span>Avenue Abderrahim Bouabid, Agdal Rabat</span>
        </li>
        <li class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#95714F]" viewBox="0 0 20 20" fill="currentColor">
            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
          </svg>
          <span>+212 5 00 40 67 89</span>
        </li>
        <li class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-[#95714F]" viewBox="0 0 20 20" fill="currentColor">
          ...
          <span>contact@lamicasa.com</span>
        </li>
      </ul>
    </div>
